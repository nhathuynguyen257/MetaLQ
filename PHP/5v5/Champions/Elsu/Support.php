...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 9 AND lane.id_lane = 5 AND role_champions.id_role = 2";
                                ...
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                        ...
                                        <div class="map-mode ch-ct">
                                            ...
                                            <a href="../?php echo $GLOBALS['name'] ?>/3v3.php" class="3v3-page ge-st"
                                                style="border-bottom-color: #fff;">
        ...
        <div class="bct-inner te-st">
            <div class="bct-text bct-bg">
                ...
                <div class="bct-p">
                    ...
                    $itemNum = "18,37,70,17,2,49,1,1,22,2,11,2,2,23,4,5,1,19,1,19,67,1,19,12,69";
                    $row_array = explode(',', $itemNum);
                    for ($i = 0; $i < count($row_array); $i++) {
                        $sql = "SELECT * FROM items WHERE id_items = $row_array[$i]";
                        $result = mysqli_query($conn, $sql);
