...
// sql 3 table stats, champions and role
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 1 AND lane.id_lane = 4 AND role_champions.id_role = 1";
                        ...
                        <div style="display: flex;justify-content: center;" class="ch-ct">
                            <div class="h-content content-details">
                                ...
                                <div class="lane-content ch-ct">
                                    <a href="../Illumia/Top.php" class="text-ac bot-ac"
                                        style="border-bottom-color: #fff;">
                                        <span>
                                    ...
                                    <a href="../Illumia/Mid.php" class="text-ac ge-st"
                                        style="border-bottom-color: #fff;">
                                        <span>
                                    ...
                                    <a href="../Illumia/ADC.php" class="text-ac ge-st"
                                        style="border-bottom-color: #fff;">
                                        <span>
                                    ...
                                    <a href="../Illumia/Support.php" class="text-ac ge-st"
                                        style="border-bottom-color: #fff;">
                                        <span>
                                                                        ...
                                                                        <div style="margin-top:1px">
                                                                            ...
                                                                            <div style="display: flex;">';
                                                                                ...
                                                                                for ($i = 0; $i < count($row_array); $i++) {
                                                                                    $sql = "SELECT * FROM champions JOIN stats_spell ON champions.id_champ = stats_spell.id_champ JOIN spells WHERE stats_spell.id_spell = spells.id_spell AND champions.champ_Name = '$name' AND stats_spell.id_spell = $row_array[$i]";
                                                                                    $result = mysqli_query($conn, $sql);
                                                                                    $row = mysqli_fetch_assoc($result);
                        ...
                        <div class="bct-text">
                            <div class="bct-paragraph bct-bg">
                                ...
                                <div class="bct-p bct-bg">
                                    <div
                                        style="width:100%;display:flex;align-items:center;justify-content: space-around;">
                                        <!-- this command show the start items of the champion(đây là phần hiển 
                                                    thị vật phẩm bắt đầu của tướng)-->
                                        <?php
                                                                $sql = "SELECT * FROM champions JOIN stats_start_items ON champions.id_champ = stats_start_items.id_champ JOIN items WHERE stats_start_items.id_items = items.id_items AND stats_start_items.id_lane = 4 AND champions.id_champ = $GLOBALS[id]";
                                                                $result = mysqli_query($conn, $sql);
                                                                $count = mysqli_num_rows($result);
                                                                $row = mysqli_fetch_assoc($result);
                                                                if ($count > 0) {
                                                            ...
                                                            <div style="margin-top:1px">
                                                                <div class="items items-bg">
                                                                    ...
                                                                    for ($i = 0; $i < count($row_array); $i++) {
                                                                        ...
                                                                        AND stats_start_items.id_lane = 4 AND champions.id_champ = $GLOBALS[id] AND stats_start_items.id_items = $row_array[$i]";
                                                                        $result = mysqli_query($conn, $sql);
                                                                        $row = mysqli_fetch_assoc($result);
                                                                        if ($i <= count($row_array)) {
                ...
                <div class="bct-paragraph bct-bg">
                    ...
                    <div id="active-runes" class="bct-p bct-bg">
                        ...
                        <div style="margin-top:30px;">
                                ...
                                <div style="display:flex;margin-bottom:-10px;margin-top:-30px;">
                                    ...
                                    <div class="be badge-st">
                                        <svg xmlns="https://www.w3.org/2000/svg" version="1.1" width="72" height="72">
                                            ...
                                            <image class="badge-img" x="0" y="0" height="72" width="72"
                                                xlink:href="../../../../Images/PhuHieu/ThanhThuan.png">
                                            </image>
                                        </svg>
                                    </div>
                                    <div class="be badge-st">
                            ...
                            <!-- div show the details of the second badge( show chi tiet phu hieu thu 2)-->
                    ...
                    <div class="bct-p">
                        <div style="width:100%;display:flex;justify-content:space-around;flex-wrap:wrap"
                            ...
                            <div style="display:flex;align-items:center;justify-content:center;">
                                <?php
                                                // 64: gươm loki, 47: giay thuật sĩ, 53: sach truy hon, 60: truong bung no,58:vuong mien hecate, 61: xuyen tam lenh, 62: sach thanh
                                               $itemNum = "64,47,60,58,61,62";
                                               $row_array = explode(',', $itemNum);
                                               for ($i = 0; $i < count($row_array); $i++) {
                                ...
                                <tbody>
                                    <?php
                                                ...
                                                <tr class="skills">
                                                    ...
                                                    for ($i = 1; $i <= 15;$i++) {
                                                        if($i == 2 || $i == 6 || $i == 10 || $i == 13 || $i == 14 || $i == 15){
            ...
            <div class="bct-text bct-bg">
                ...
                <div class="bct-p">
                    ...
                    <?php
                                   ...
                                   $itemNum = "16,42,64,17,47,6,59,60,6,25,58,6,61,6,25,62";
                                   $row_array = explode(',', $itemNum);
                                   for ($i = 0; $i < count($row_array); $i++) {
                                       $sql = "SELECT * FROM items WHERE id_items= $row_array[$i]";
                                       $result = mysqli_query($conn, $sql);
