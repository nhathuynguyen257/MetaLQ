...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 21 AND lane.id_lane = 1 AND role_champions.id_role = 5";
                                ...
                                <div style="display:flex;margin-bottom:-10px;margin-top:-30px;">
                                    ...
                                    <div class="be badge-st">
                                        <svg xmlns="https://www.w3.org/2000/svg" version="1.1" width="72" height="72">
                                            ...
                                            <image class="badge-img" x="0" y="0" height="72" width="72"
                                                xlink:href="../../../../Images/PhuHieu/DuHiep.png">
                                            </image>
                                        </svg>
                                    </div>
                                    <div class="be badge-st">
            ...
            <div class="bct-text bct-bg">
                ...
                <div class="bct-p">
                    ...
                    <?php
                         ...
                         $itemNum = "17,13,46,6,6,59,6,6,60,6,6,25,6,6,25,58,6,6,25,11,15,53,6,6,27,11,6,32,6,6,25,6,6,25,62";
                         $row_array = explode(',', $itemNum);
                         for ($i = 0; $i < count($row_array); $i++) {
                             $sql = "SELECT * FROM items WHERE id_items = $row_array[$i]";
                             $result = mysqli_query($conn, $sql);
        ...
        <div class="bct-inner te-st">
            <div class="bct-bg counter-content">
                ...
                <div style="padding-top: 10px;" class="counters-grid">
                    <?php
                         $sql = "SELECT * FROM champions JOIN stats ON champions.id_champ = stats.id_Champ JOIN lane WHERE stats.id_lane = lane.id_lane AND stats.id_lane = 1 EXCEPT SELECT * FROM champions JOIN stats ON champions.id_champ = stats.id_Champ JOIN lane WHERE stats.id_Champ = 1 AND stats.id_lane = 1";
                         $result = mysqli_query($conn, $sql);
