...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 21 AND lane.id_lane = 4 AND role_champions.id_role = 5";
        ...
        <div class="bct-inner te-st">
            <div class="bct-text bct-bg">
                ...
                <div class="bct-p">
                    ...
                    $itemNum = "16,43,85,17,46,9,13,34,9,13,78,79,12,12,36,12,11,13,7,79,9,9,31,12,12,38,1,19,9,69";
                    $row_array = explode(',', $itemNum);
                    for ($i = 0; $i < count($row_array); $i++) {
                        $sql = "SELECT * FROM items WHERE id_items = $row_array[$i]";
                        $result = mysqli_query($conn, $sql);
