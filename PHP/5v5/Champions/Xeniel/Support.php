...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 21 AND lane.id_lane = 5 AND role_champions.id_role = 5";
                                            ...
                                            <div class="descript-para" style="display: flex;">
                                                <span>
                                                    <p class="para-inner">
                                                        ...
                                                        <<?php echo $GLOBALS['name'] ?> trong patch 24. </p>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div style="display: flex;justify-content: center;" class="ch-ct">
                            <div class="h-content content-details">
                                ...
                                <div class="lane-content ch-ct">
                                    <a href="../<?php echo $GLOBALS['name'] ?>/Top.php" class="text-ac bot-ac"
                                        style="border-bottom-color: #fff;">
                                        <span>
                                    ...
                                    <a href="../<?php echo $GLOBALS['name'] ?>/Jungle.php" class="text-ac ge-st"
                                        style="border-bottom-color: #fff;">
                                        <span>
                            ...
                            <div class="bct-paragraph bct-bg">
                                ...
                                <div class="bct-p bct-bg">
                                    <div
                                        ...
                                        <?php
                                                                $sql = "SELECT * FROM champions JOIN stats_start_items ON champions.id_champ = stats_start_items.id_champ JOIN items WHERE stats_start_items.id_items = items.id_items AND stats_start_items.id_lane = 5 AND champions.id_champ = $GLOBALS[id]";
                                                                $result = mysqli_query($conn, $sql);
                                                                $count = mysqli_num_rows($result);
                                                                $row = mysqli_fetch_assoc($result);
                                                                if ($count > 0) {
                                                            ...
                                                            <div style="margin-top:1px">
                                                                <div class="items items-bg">
                                                                    ...
                                                                    for ($i = 0; $i < count($row_array); $i++) {
                                                                        ...
                                                                        AND stats_start_items.id_lane = 5 AND champions.id_champ = $GLOBALS[id] AND stats_start_items.id_items = $row_array[$i]";
                                                                        $result = mysqli_query($conn, $sql);
                                                                        $row = mysqli_fetch_assoc($result);
                                                                        if ($i <= count($row_array)) {
                                ...
                                <div style="display:flex;flex-wrap:wrap;margin-bottom:-10px;">
                                    ...
                                    <div class="be badge-st">
                                        <svg xmlns="https://www.w3.org/2000/svg" version="1.1" width="72" height="72">
                                            ...
                                            <image class="badge-img" x="16" y="16" height="40" width="40"
                                                xlink:href="../../../../Images/PhuHieu/CanhGac.png">
                                            </image>
                                            <circle cx="36" cy="36" r="20" fill="transparent" stroke="rgb(10,0,148)"
                                                stroke-width="2">
                                            </circle>
            ...
            <div class="bct-text bct-bg">
                ...
                <div class="bct-p">
                    ...
                    <?php
                                   ...
                                   $itemNum = "18,37,70,17,46,12,11,13,9,9,86,12,33,14,15,87,12,12,36,9,9,31,79,1,19,9,69";
                                   $row_array = explode(',', $itemNum);
                                   for ($i = 0; $i < count($row_array); $i++) {
                                       $sql = "SELECT * FROM items WHERE id_items = $row_array[$i]";
                                       $result = mysqli_query($conn, $sql);
                    ...
                    <?php
                      ...
                      $row = mysqli_num_rows($result);
                          while ($row = mysqli_fetch_assoc($result)) {
                              ...
                              echo
                              '<a href = "../../../5v5/Champions/'.$champ_name.'/Support.php">
