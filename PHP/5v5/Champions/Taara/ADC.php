...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 25 AND lane.id_lane = 3 AND role_champions.id_role = 4";
        ...
        <div class="bct-inner te-st">
            <div class="bct-text bct-bg">
                ...
                <div class="bct-p">
                    ...
                    $itemNum = "12,33,14,15,87,17,12,45,1,1,22,11,9,82,12,12,36,9,9,31,80,9,13,34,13,9,78,1,19,9,69";
                    $row_array = explode(',', $itemNum);
                    for ($i = 0; $i < count($row_array); $i++) {
                        $sql = "SELECT * FROM items WHERE id_items = $row_array[$i]";
                        $result = mysqli_query($conn, $sql);
