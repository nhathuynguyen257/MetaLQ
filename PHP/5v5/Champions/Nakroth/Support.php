...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 15 AND lane.id_lane = 5 AND role_champions.id_role = 6";
                                ...
                                <div style="display:flex;margin-bottom:-10px;margin-top:-30px;">
                                    ...
                                    <div class="be badge-st">
                                        <svg xmlns="https://www.w3.org/2000/svg" version="1.1" width="72" height="72">
                                            ...
                                            <image class="badge-img" x="16" y="16" height="40" width="40"
                                                xlink:href="../../../../Images/PhuHieu/AmKich.png">
                                            </image>
                                            <circle cx="36" cy="36" r="20" fill="transparent" stroke="rgb(91, 208, 82)"
                                                stroke-width="2">
                                            </circle>
