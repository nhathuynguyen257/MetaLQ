...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 15 AND lane.id_lane = 1 AND role_champions.id_role = 6";
                            ...
                            <div class="tooltip-container tp-cr">
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                                ...
                                                <div style="display: flex;">
                                                    ...
                                                    <div class="title">
                                                        <h1 class="title-inner1"
                                                            ...
                                                            <span
                                                                style="display: flex;font-size: 30px;font-family:Fahkwang, sans-serif">
                                        ...
                                        rate, KDA(đây là phần hiển thị thông tin của tướng bao gồm
                                        tier, tỉ lệ thắng, tỉ lệ chọn, tỉ lệ cấm, KDA) -->
        ...
        <div class="bct-inner te-st">
            <div class="bct-bg counter-content">
                ...
                <div style="padding-top: 10px;" class="counters-grid">
                    <?php
                      $sql = "SELECT * FROM champions JOIN stats ON champions.id_champ = stats.id_Champ JOIN lane WHERE stats.id_lane = lane.id_lane AND stats.id_lane = 1 EXCEPT SELECT * FROM champions JOIN stats ON champions.id_champ = stats.id_Champ JOIN lane WHERE stats.id_Champ = $GLOBALS[id] AND stats.id_lane = $GLOBALS[id_lane]";
                      $result = mysqli_query($conn, $sql);
