...
$sql = "SELECT * from champions JOIN stats ON champions.id_champ = stats.id_champ JOIN lane ON lane.id_lane = stats.id_lane JOIN role_champions ON role_champions.id_role = champions.id_role WHERE champions.id_champ = 15 AND lane.id_lane = 4 AND role_champions.id_role = 6";
                            ...
                            <div id="10-1-tab" class="tab-selected badge b-hover" style="cursor:pointer"
                                ...
                                <div class="activerunes-image drop-hover badge-st be badge-2">
                                    <svg xmlns="https://www.w3.org/2000/svg" version="1.1" width="54" height="45">
                                        ...
                                        <circle cx="27" cy="27" r="15" fill="transparent" stroke="rgb(10,0,148)"
                                            stroke-width="2">
                                        </circle>
                                    </svg>
                                </div>
