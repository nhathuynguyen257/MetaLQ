...
<?php
    ...
    $sql = "SELECT * FROM role_champions JOIN champions ON champions.id_role = role_champions.id_role JOIN lane WHERE  champions.ID = 14";
                                ...
                                <div style="position:relative">
                                    <div id="splash-content" class="spct-st">
                                        ...
                                        <div class="map-mode ch-ct">
                                            ...
                                            <a href="#" class="active home-page ge-st" class="3v3-page ge-st"
